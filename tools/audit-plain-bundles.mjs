...
export async function auditPlainBundles(directory, entries = ["games/coil/plain/index.html", "games/starfall/plain/index.html"]) {
  ...
  for (const entry of entries) {
    ...
    for (const file of files) {
      ...
      const leaked = source.match(/\bmodelContext\b|huginn\/experiment-v1|\bsnapshot_game\b|\bapply_action_sequence\b|\brollbackSnapshotId\b/);
